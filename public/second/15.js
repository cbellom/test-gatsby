...
const AmplifyAuthenticator = class {
    constructor(hostRef) {
        ...
        this.handleExternalAuthEvent = ({ payload }) => {
            switch (payload.event) {
                ...
                case 'signIn':
                    Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["c"])(payload.data, _helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["d"]);
                    break;
                case 'cognitoHostedUI_failure':
                case 'parsingUrl_failure':
                case 'signOut':
                case 'customGreetingSignOut':
                    return Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this.initialAuthState);
            }
        };
        this.handleToastEvent = ({ payload }) => {
            switch (payload.event) {
                case _constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["T"]:
                    if (payload.message)
    ...
    async componentWillLoad() {
        Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["o"])((authState, authData) => {
            this.onAuthStateChange(authState, authData);
            this.toastMessage = '';
        });
        if (!this.hideToast)
            _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["U"], this.handleToastEvent);
        _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].listen(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["A"], this.handleExternalAuthEvent);
    ...
    async checkUser() {
        ...
        return _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].currentAuthenticatedUser()
            .then(user => {
            Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["d"])(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn, user);
        })
            .catch(async () => {
            let cachedAuthState = null;
            try {
                cachedAuthState = localStorage.getItem(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["c"]);
            }
            catch (error) {
            ...
            try {
                ...
                Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["d"])(this.initialAuthState);
            }
            catch (error) {
    ...
    getAuthComponent(authState) {
        switch (authState) {
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn:
                return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in", { federated: this.federated, usernameAlias: this.usernameAlias }));
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ConfirmSignIn:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-confirm-sign-in", { user: this.authData });
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignUp:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-up", { usernameAlias: this.usernameAlias });
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ConfirmSignUp:
                return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-confirm-sign-up", { user: this.authData, usernameAlias: this.usernameAlias }));
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ForgotPassword:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-forgot-password", { usernameAlias: this.usernameAlias });
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ResetPassword:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-require-new-password", { user: this.authData });
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].VerifyContact:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-verify-contact", { user: this.authData });
            case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].TOTPSetup:
                return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-totp-setup", { user: this.authData });
    ...
    getSlotWithAuthComponent(authState) {
         ...
         */
        return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: slotName }, slotIsEmpty && authComponent);
    }
    disconnectedCallback() {
        _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].remove(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["A"], this.handleExternalAuthEvent);
        if (!this.hideToast)
            _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["Hub"].remove(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["U"], this.handleToastEvent);
        return _helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["o"];
    }
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, !this.hideToast && this.toastMessage && (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-toast", { message: this.toastMessage, handleClose: () => {
                this.toastMessage = '';
            }, "data-test": "authenticator-error" })), this.authState === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignedIn ? ([Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "greetings" }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)]) : (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "auth-container" }, this.getSlotWithAuthComponent(this.authState)))));
    }
