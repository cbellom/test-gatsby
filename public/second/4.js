...
const AmplifyChatbot = class {
    constructor(hostRef) {
        ...
        this.messageJSX = (messages) => {
            const messageList = messages.map(message => (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: `bubble ${message.from}` }, message.content)));
            if (this.chatState === ChatState.SendingText ||
                ...
                const client = this.chatState === ChatState.SendingText
                    ? MessageFrom.Bot
                    : MessageFrom.User;
                messageList.push(Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: `bubble ${client}` }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: `dot-flashing ${client}` }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "dot left" }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "dot middle" }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "dot right" }))));
            }
            return messageList;
        };
    ...
    componentWillLoad() {
        if (!_aws_amplify_interactions__WEBPACK_IMPORTED_MODULE_5__["Interactions"] || typeof _aws_amplify_interactions__WEBPACK_IMPORTED_MODULE_5__["Interactions"].onComplete !== 'function') {
            throw new Error(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_4__["d"]);
        }
        this.validateProps();
    }
    componentDidRender() {
    ...
    listeningFooterJSX() {
        const visualization = Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("canvas", { height: "50" });
        const cancelButton = (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { "data-test": "chatbot-cancel-button", handleButtonClick: () => this.handleCancelButton(), class: "icon-button", variant: "icon", icon: "ban" }));
    ...
    footerJSX() {
        ...
        const textInput = (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", { placeholder: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(inputPlaceholder), description: "text", handleInputChange: evt => this.handleTextChange(evt), value: this.text, disabled: this.chatState === ChatState.Error || !this.textEnabled }));
        const micButton = this.voiceEnabled && (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { "data-test": "chatbot-mic-button", handleButtonClick: () => this.handleMicButton(), class: "icon-button", variant: "icon", icon: "microphone", disabled: this.chatState === ChatState.Error ||
                this.chatState !== ChatState.Initial }));
        const sendButton = this.textEnabled && (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { "data-test": "chatbot-send-button", class: "icon-button", variant: "icon", icon: "send", handleButtonClick: () => this.sendTextMessage(), disabled: this.chatState === ChatState.Error ||
                this.chatState !== ChatState.Initial }));
    ...
    errorToast() {
        ...
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-toast", { message: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(message), handleClose: () => this.handleToastClose(errorType) }));
    }
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "amplify-chatbot" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "header" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "header", "data-test": "chatbot-header" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.botTitle))), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "body", "data-test": "chatbot-body" }, this.messageJSX(this.messages)), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("form", { onSubmit: e => this.handleSubmit(e) }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "footer", "data-test": "chatbot-footer" }, this.footerJSX())), this.errorToast())));
    }
    get element() { return Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
};
