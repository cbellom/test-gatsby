...
/***/ "TX1d":
/*!**************************************************************************************!*\
  !*** ./node_modules/@aws-amplify/ui-components/dist/esm/storage-helpers-95bd359a.js ***!
  \**************************************************************************************/
...
/* harmony import */ var _constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants-d7afd96c.js */ "tZvK");
...
/* harmony import */ var _helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers-80b400b1.js */ "pHM5");
...
async function checkContact(user, handleAuthStateChange) {
    ...
    try {
        ...
        Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error);
    }
}
const handleSignIn = async (username, password, handleAuthStateChange, usernameAlias) => {
    ...
    try {
        ...
        logger.debug(user);
        if (user.challengeName === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__["C"].SMSMFA ||
            user.challengeName === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__["C"].SoftwareTokenMFA) {
        ...
        else if (error.message === _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMPTY_USERNAME) {
            if (usernameAlias === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__["U"].email) {
                error.message = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMPTY_EMAIL;
            }
            if (usernameAlias === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_1__["U"].phone_number) {
                error.message = _Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_3__["T"].EMPTY_PHONE;
            }
        }
        Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_5__["a"])(error);
    }
