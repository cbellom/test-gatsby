    ...
    constructor(hostRef) {
        ...
        this.handlePick = async (file) => {
            ...
            try {
                ...
                this.src = await Object(_storage_helpers_95bd359a_js__WEBPACK_IMPORTED_MODULE_7__["g"])(key, level, track, identityId, logger);
            }
            catch (error) {
                logger.error(error);
