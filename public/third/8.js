...
const AmplifyS3Text = class {
    ...
    async load() {
        ...
        if (body) {
            await Object(_storage_helpers_95bd359a_js__WEBPACK_IMPORTED_MODULE_7__["p"])(textKey, body, level, track, contentType, logger);
        }
        try {
            this.src = await Object(_storage_helpers_95bd359a_js__WEBPACK_IMPORTED_MODULE_7__["a"])(key, level, track, identityId, logger);
        }
        catch (err) {
            logger.debug(err);
            throw new Error(err);
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "text-container" }, this.src ? (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("pre", null, this.src)) : (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("pre", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.fallbackText))))));
    }
