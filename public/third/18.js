...
/* harmony import */ var _auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./auth-helpers-aad95737.js */ "otS2");
...
const AmplifyConfirmSignIn = class {
    ...
    setup() {
        if (this.user &&
            this.user['challengeName'] === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["C"].SoftwareTokenMFA) {
    ...
    async confirm(event) {
        ...
        const mfaType = this.user['challengeName'] === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["C"].SoftwareTokenMFA
            ? _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["C"].SoftwareTokenMFA
            : null;
        ...
        try {
            ...
            await Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["c"])(this.user, this.handleAuthStateChange);
        }
        catch (error) {
            Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
        }
        finally {
            this.loading = false;
        }
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-section", { headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.headerText), handleSubmit: this.handleSubmit, submitButtonText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.submitButtonText), loading: this.loading, secondaryFooterContent: Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn) }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].BACK_TO_SIGN_IN))) }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-auth-fields", { formFields: this.constructedFormFieldOptions }))));
    }
...
const AmplifyConfirmSignUp = class {
    constructor(hostRef) {
        ...
        this.newFormFields = [];
        this.phoneNumber = {
            countryDialCodeValue: _constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["h"],
    ...
    setup() {
        ...
        Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["c"])(this.usernameAlias);
        this.buildFormFields();
    }
    ...
    handleFormFieldInputChange(fieldType) {
        switch (fieldType) {
            ...
            case 'phone_number':
                return event => Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, this.phoneNumber);
            case 'code':
    ...
    getUsername() {
        ...
        switch (this.usernameAlias) {
            ...
            case 'phone_number':
                return Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
        }
    }
    async resendConfirmCode() {
        ...
        try {
            ...
            await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].resendSignUp(username.trim());
        }
        catch (error) {
            Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
        }
    ...
    async confirmSignUp(event) {
        ...
        try {
            ...
            const confirmSignUpResult = await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].confirmSignUp(username, this.code);
            ...
            if (this._signUpAttrs &&
                ...
                await Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this._signUpAttrs.password, this.handleAuthStateChange);
            }
            else {
...
const AmplifyForgotPassword = class {
    ...
    async send(event) {
        ...
        switch (this.usernameAlias) {
            case 'phone_number':
                try {
                    this.forgotPasswordAttrs.userInput = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                }
                catch (error) {
                    Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
    ...
    async submit(event) {
        ...
        try {
            ...
            const data = await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].forgotPasswordSubmit(userInput.trim(), code, password);
            logger.debug(data);
            this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn);
            this.delivery = null;
        }
    ...
    render() {
        ...
        const submitButtonText = this.delivery
            ...
            : this.sendButtonText;
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-section", { headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.headerText), handleSubmit: submitFn, loading: this.loading, secondaryFooterContent: Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn), "data-test": "forgot-password-back-to-sign-in-link" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].BACK_TO_SIGN_IN)), testDataPrefix: 'forgot-password', submitButtonText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(submitButtonText) }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-auth-fields", { formFields: this.newFormFields }))));
    }
    static get watchers() { return {
        "formFields": ["formFieldsHandler"]
    }; }
...
const AmplifyRequireNewPassword = class {
    ...
    async setCurrentUser() {
        ...
        if (this.currentUser &&
            ...
            const userRequiredAttributes = this.currentUser.challengeParam
                .requiredAttributes;
            const requiredAttributesMap = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["g"])();
    ...
    formatPhoneNumber(event) {
        Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["h"])(event, this.phoneNumber);
        /**
         ...
         */
        try {
            if (event.target.name === _constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["b"] &&
                this.phoneNumber.phoneNumberValue) {
                const composedInput = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
        ...
        try {
            ...
            switch (user.challengeName) {
                ...
                case _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["C"].MFASetup:
                    ...
                    break;
                default:
                    await Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["c"])(user, this.handleAuthStateChange);
            }
        }
        catch (error) {
            Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
...
const AmplifySignIn = class {
    ...
    async signIn(event) {
        ...
        switch (this.usernameAlias) {
            case 'phone_number':
                try {
                    this.signInAttributes.userInput = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
                }
                catch (error) {
                    Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
                }
        ...
        await Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["h"])(username, this.signInAttributes.password, this.handleAuthStateChange, this.usernameAlias);
        this.loading = false;
    }
    buildDefaultFormFields() {
        ...
        formFieldInputs.push({
            type: 'password',
            hint: (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].FORGOT_PASSWORD_TEXT), ' ', Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].ForgotPassword), "data-test": "sign-in-forgot-password-link" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].RESET_PASSWORD_TEXT)))),
            required: true,
            handleInputChange: this.handleFormFieldInputChange('password'),
            inputProps: {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-section", { headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.headerText), handleSubmit: this.handleSubmit, testDataPrefix: 'sign-in' }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { slot: "subtitle" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "header-subtitle" })), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "federated-buttons" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-federated-buttons", { handleAuthStateChange: this.handleAuthStateChange, federated: this.federated })), !Object(_aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["isEmpty"])(this.federated) && Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-strike", null, "or"), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-auth-fields", { formFields: this.newFormFields }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { slot: "amplify-form-section-footer", class: "sign-in-form-footer" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "footer" }, !this.hideSignUp && (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "secondary-footer-content" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].NO_ACCOUNT_TEXT), ' ', Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignUp), "data-test": "sign-in-create-account-link" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].CREATE_ACCOUNT_TEXT))))), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: this.hideSignUp ? 'full-width-footer-content' : '' }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "primary-footer-content" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { type: "submit", disabled: this.loading, "data-test": "sign-in-sign-in-button" }, this.loading ? (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-loading-spinner", null)) : (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.submitButtonText)))))))))));
    }
    static get watchers() { return {
        "formFields": ["formFieldsHandler"]
    }; }
...
const AmplifySignUp = class {
    ...
    async authSignUp(params) {
        const data = await _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].signUp(params);
        if (!data) {
    ...
    assignPhoneNumberToSignUpAttributes() {
        if (this.phoneNumber.phoneNumberValue) {
            try {
                this.signUpAttributes.attributes.phone_number = Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["b"])(this.phoneNumber);
            }
            catch (error) {
                Object(_helpers_80b400b1_js__WEBPACK_IMPORTED_MODULE_6__["a"])(error);
            }
    ...
    validateSignUpAttributes() {
        if (!this.signUpAttributes.username) {
            if (this.usernameAlias === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["U"].email) {
                throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].EMPTY_EMAIL);
            }
            else if (this.usernameAlias === _auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["U"].phone_number) {
                throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].EMPTY_PHONE);
            }
            else {
                throw new Error(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].EMPTY_USERNAME);
            }
    ...
    async signUp(event) {
        ...
        try {
            ...
            if (data.userConfirmed) {
                await Object(_auth_helpers_aad95737_js__WEBPACK_IMPORTED_MODULE_7__["h"])(this.signUpAttributes.username, this.signUpAttributes.password, this.handleAuthStateChange);
            }
            else {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["H"], null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-form-section", { headerText: _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.headerText), handleSubmit: this.handleSubmit, testDataPrefix: 'sign-up' }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { slot: "subtitle" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "header-subtitle" })), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-auth-fields", { formFields: this.newFormFields }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "sign-up-form-footer", slot: "amplify-form-section-footer" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "footer" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "secondary-footer-content" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.haveAccountText), ' ', Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { variant: "anchor", onClick: () => this.handleAuthStateChange(_auth_types_78df304e_js__WEBPACK_IMPORTED_MODULE_2__["A"].SignIn), "data-test": "sign-up-sign-in-link" }, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.signInText)))), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "primary-footer-content" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-button", { type: "submit", "data-test": "sign-up-create-account-button", disabled: this.loading }, this.loading ? (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-loading-spinner", null)) : (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", null, _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(this.submitButtonText))))))))));
    }
    static get watchers() { return {
        "formFields": ["formFieldsHandler"]
    }; }
...
const AmplifyVerifyContact = class {
    ...
    renderSubmit() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", null, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-input", { inputProps: {
                autocomplete: 'off',
