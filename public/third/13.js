...
const AmplifyAmazonButton = class {
    constructor(hostRef) {
        ...
        this.federatedSignIn = response => {
            ...
            if (!_aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"] ||
                typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].federatedSignIn !== 'function' ||
                typeof _aws_amplify_auth__WEBPACK_IMPORTED_MODULE_3__["Auth"].currentAuthenticatedUser !== 'function') {
    ...
    signInWithAmazon(event) {
        ...
        window['amazon'].Login.authorize({ scope: 'profile' }, response => {
            ...
            try {
                window.localStorage.setItem(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify({ provider: 'amazon' }));
            }
            catch (e) {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in-button", { onClick: event => this.signInWithAmazon(event), provider: "amazon" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("script", { src: "https://assets.loginwithamazon.com/sdk/na/login1.js" }), _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SIGN_IN_WITH_AMAZON)));
    }
};
...
const AmplifyAuth0Button = class {
    constructor(hostRef) {
        ...
        this.handleLoad = () => {
            ...
            this._auth0.parseHash((err, authResult) => {
                ...
                try {
                    localStorage.setItem(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify(payload));
                }
                catch (e) {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in-button", { onClick: event => this.signInWithAuth0(event), provider: "auth0" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("script", { onLoad: this.handleLoad, src: "https://cdn.auth0.com/js/auth0/9.11/auth0.min.js" }), _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SIGN_IN_WITH_AUTH0)));
    }
};
    ...
    constructor(hostRef) {
        ...
        this.getLoginStatus = () => {
            window['FB'].getLoginStatus(response => {
                try {
                    window.localStorage.setItem(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify({ provider: 'facebook' }));
                }
                catch (e) {
...
const AmplifyGoogleButton = class {
    constructor(hostRef) {
        ...
        this.handleUser = async (user) => {
            ...
            try {
                window.localStorage.setItem(_constants_d7afd96c_js__WEBPACK_IMPORTED_MODULE_5__["j"], JSON.stringify({ provider: 'google' }));
            }
            catch (e) {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in-button", { onClick: event => this.signInWithGoogle(event), provider: "google" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("script", { onLoad: this.handleLoad, src: "https://apis.google.com/js/api:client.js" }), _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SIGN_IN_WITH_GOOGLE)));
    }
};
...
const AmplifyOAuthButton = class {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-sign-in-button", { onClick: event => this.signInWithOAuth(event), provider: "oauth" }, this.config.label || _aws_amplify_core__WEBPACK_IMPORTED_MODULE_1__["I18n"].get(_Translations_c833f663_js__WEBPACK_IMPORTED_MODULE_4__["T"].SIGN_IN_WITH_AWS)));
    }
};
