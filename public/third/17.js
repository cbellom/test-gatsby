...
const AmplifyCheckbox = class {
    ...
    render() {
        return (Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "checkbox" }, Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("input", { onClick: this.onClick, type: "checkbox", name: this.name, value: this.value, id: this.fieldId, checked: this.checked, disabled: this.disabled }), Object(_index_83f2275b_js__WEBPACK_IMPORTED_MODULE_0__["h"])("amplify-label", { htmlFor: this.fieldId }, this.label)));
    }
};
